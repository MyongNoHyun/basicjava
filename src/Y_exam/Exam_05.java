...
//		하시오.
//		a. int[] arr[];							=>문제없음
//		b. int[] arr = {1,2,3,};				=>문제없음
//		c. int[] arr = new int[5];				=>문제없음
//		d. int[] arr = new int[5]{1,2,3,4,5};	=>선언, 생성, 초기화
//		e. int arr[5];							=>문제없음
//		f. int[] arr[] = new int[3][];			=>문제없음
	
//		[5-2] 다음과 같은 배열이 있을 때, arr[3].length의 값은 얼마인가?
//				int[][] arr = {
//				{ 5, 5, 5, 5, 5},	=>arr[0].length
//				{ 10, 10, 10},		=>arr[1].length
//				{ 20, 20, 20, 20},	=>arr[2].length
//				{ 30, 30}			=>arr[3].length
//				};								=>2개		
...
//						(1) 알맞은 코드를 넣어 완성하시오.
//						result[i][sore[i].length]+=score[i][j]
